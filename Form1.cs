...
namespace BingRewardsBot
{
    public partial class Form1 : Form
    {
        ...
        const string VERSION = "02.07.2017";
        const string ASSEMBLY = "39";
        ...
        private const string BRI18NFR = "https://bing.com/account/action?scope=web&setmkt=fr-FR&setplang=fr-fr&setlang=fr-fr&FORM=W5WA&uid=BAB04A31&sid=";
        private const string BRI18NDE = "https://bing.com/account/action?scope=web&setmkt=de-DE&setplang=de-de&setlang=de-de&FORM=W5WA&uid=BAB04A31&sid=";
        private const string BRI18NGB = "https://bing.com/account/action?scope=web&setmkt=en-GB&setplang=en-gb&setlang=en-gb&FORM=W5WA&uid=F0B04721&sid=";
        private const string BRI18NAU = "https://bing.com/account/action?scope=web&setmkt=en-AU&setplang=en-au&setlang=en-au&FORM=W5WA&uid=BAB04A31&amp;sid=";
        ...
        {            
            ...
            this.chkbox_autolang.Checked = BingRewardsBot.Properties.Settings.Default.set_chkbox_autolang == true ? true : false;
        ...
        */
        ...
        async Task DoUnsupportedMarket()
        {
            ...
            */
            else if (listBox1.SelectedIndex == 1)
            {
                ...
                await DownloadAsync(BRI18NGB + this.siguid).ContinueWith(
                    (task) => this.statusDebug("UM1.1:"),
                        TaskScheduler.FromCurrentSynchronizationContext());
                ...
                await DownloadAsync("https://account.microsoft.com/?lang=en-GB").ContinueWith(
                    (task) => this.statusDebug("UM1.1:"),
                        TaskScheduler.FromCurrentSynchronizationContext());
            }
            else if (listBox1.SelectedIndex == 2)
            {
                ...
                await DownloadAsync(BRI18NFR + this.siguid).ContinueWith(
                    (task) => this.statusDebug("UM1.1:"),
                        TaskScheduler.FromCurrentSynchronizationContext());
                ...
                await DownloadAsync("https://account.microsoft.com/?lang=fr-FR").ContinueWith(
                    (task) => this.statusDebug("UM1.1:"),
                        TaskScheduler.FromCurrentSynchronizationContext());
            }
            else if (listBox1.SelectedIndex == 3)
            {
                ...
                await DownloadAsync(BRI18NDE + this.siguid).ContinueWith(
                    (task) => this.statusDebug("UM1.1:"),
                        TaskScheduler.FromCurrentSynchronizationContext());
                ...
                await DownloadAsync("https://account.microsoft.com/?lang=de-DE").ContinueWith(
                    (task) => this.statusDebug("UM1.1:"),
                        TaskScheduler.FromCurrentSynchronizationContext());
            }
            else if (listBox1.SelectedIndex == 4)
            {
                ...
                await DownloadAsync(BRI18NAU + this.siguid).ContinueWith(
                    (task) => this.statusDebug("UM1.1:"),
                        TaskScheduler.FromCurrentSynchronizationContext());
                ...
                await DownloadAsync("https://account.microsoft.com/?lang=en-AU").ContinueWith(
                    (task) => this.statusDebug("UM1.1:"),
                        TaskScheduler.FromCurrentSynchronizationContext());
            }
                ...
                */
                   ...
                   )
                {
                    ...
                    )
                    {
                        ...
                        else if (this.dashboardta == false)
                        {
                            //DoUnsupportedMarket();
        ...
        private async void DoSearch(object sender, EventArgs e)
        {
            ...
            else if (this.trialstopped == false)
            {
                ...
                // max out
                if (this.counterDx <= 0 && this.dxloops < MAXLOOPS)
                {
                    this.dxloops++;
                    string[] wait = Properties.Settings.Default.set_counter.ToString().Split('-');
                    this.counterDx = this.countDownDesktop = randomNumber(Convert.ToInt32(wait[0]),
                ...
                if (this.counterMx <= 0 && this.mxloops < MAXLOOPS && SUPPORTER == true)
                {
                    this.mxloops++;
                    string[] wait = Properties.Settings.Default.set_counter.ToString().Split('-');
                    this.counterMx = this.countDownMobile = randomNumber(Convert.ToInt32(wait[0]),
                ...
                */
                ...
                if (this.WDCounter > WATCHDOG)
                {
                 ...
                 )
                    {
                      ...
                      //&& (this.Csearch == true || this.clicklist == true)
                      && this.authLock == true
                      && this.browserUrlTxtbox.Text.Contains(@"search?q=")
                      && this.statusTxtBox.Text != "Dashboard"
                      && this.statusTxtBox.Text != "Connected"
                      && this.statusTxtBox.Text == "Authenticate"
                      )
        ...
        private void restartAuth()
        {
            ...
            if (v < 0)
            {
                if (this.dxloops >= MAXLOOPS && (this.mxloops >= MAXLOOPS && SUPPORTER == true))
                {
        ...
        private void log_Enter(object sender, EventArgs e)
        {
            switch ((sender as TabControl).SelectedIndex)
            {
                case 2:
                    ...
                    log.Items.Add(itm);
                    string lang = "";
                    switch (BingRewardsBot.Properties.Settings.Default.set_lang)
                    {
                        case 0:
                            lang = "Lang:US";
                            break;
                    ...
                    itm = new ListViewItem(lang);
                    itm.Font = new Font(log.Font, FontStyle.Regular);
                    log.Items.Add(itm);
                    itm = new ListViewItem(BingRewardsBot.Properties.Settings.Default.set_chkbox_autolang == true ? "Autorotate lang:true" : "Auto lang:false");
                    itm.Font = new Font(log.Font, FontStyle.Regular);
                    log.Items.Add(itm);
        ...
        private void statusDebug(string a, bool b = false)
        {
            try
            {
                ...
                string s = a + "L" + Convert.ToString(this.authLock) +
                           ...
                           "|" + this.username +
                           //"|" + Convert.ToString(this.pts) +
                           "|DX" + Convert.ToString(this.counterDx) +
                           "|MX" + Convert.ToString(this.counterMx) +
                           "|AL" + Convert.ToString(this.spoofmktl-1 < 0 ? listBox1.SelectedIndex : this.spoofmktl - 1) +
